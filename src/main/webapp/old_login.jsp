...
<%--&lt;%&ndash;                                    <label for="exampleInputEmail"></label>&ndash;%&gt;--%>
<%--                                        <label for="email"></label>--%>
<%--                                        <input type="email" name="username" class="form-control form-control-user"--%>
<%--&lt;%&ndash;                                           id="exampleInputEmail" aria-describedby="emailHelp"&ndash;%&gt;--%>
...
<%--&lt;%&ndash;                                    <a class="small" href="registration.jsp">Create an Account!</a>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                </div>&ndash;%&gt;--%>
<%--                            </div>--%>
<%--                        </div>--%>
<%--                    </div>--%>
